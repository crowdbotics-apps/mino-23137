...
admin.site.site_header = "Mino"
admin.site.site_title = "Mino Admin Portal"
admin.site.index_title = "Mino Admin"

# swagger
api_info = openapi.Info(
    title="Mino API",
    default_version="v1",
    description="API documentation for Mino App",
)
